...
<p align="center">
  <a href="warehouse-drone-simulation/">
    <img src="warehouse-drone-simulation/docs/flythrough.gif" width="65%" alt="Drone fly-through of the 3D warehouse">
  </a>
</p>

<p align="center"><b>→ <a href="warehouse-drone-simulation/">Explore the project</a></b></p>
...
|---|---|---|
| 🚁 **[Warehouse Drone Simulation](warehouse-drone-simulation/)** | 3D warehouse simulator + CNN pose regression & inventory counting | PyTorch · OpenCV · FastAPI |
| 🔬 **[Vision Transformer from Scratch](vit-classifier-from-scratch/)** | A clean ViT implementation (patch embed, MHSA, encoder) trained on CIFAR-10 | PyTorch |
...
| Project | What it does | Stack |
|---|---|---|
| 📊 **[Stock Movement Prediction with News Sentiment](stock-sentiment-prediction/)** | Fuses price, FinBERT sentiment & GloVe embeddings with a stacking ensemble | scikit-learn · PyTorch · Transformers |
